...
export function ExamplesPanel({ onPick, onClose }: { onPick: (s: Spec, name: string) => void; onClose: () => void }) {
  return (
    <div className="modal" role="dialog" aria-label="예제">
      <div className="modal-box">
        ...
        <div className="example-list">
          {LIST.map((e) => (
            <button key={e.name} type="button" onClick={() => onPick(JSON.parse(e.text) as Spec, e.name)}>
